...
import { useProjectSnippets, useProject } from "@/hooks/useProjects";
...
/**
 * Modal/Sheet component for displaying generated project snippets.
 * 
 * Features:
 * - Automatically generates snippets when opened with a project ID
 ...
 */
export function SnippetPreview({ projectId, open, onOpenChange }: SnippetPreviewProps) {
    ...
    // Generate snippets when modal opens with a valid project ID
    useEffect(() => {
        if (open && projectId && !snippetsData && !isPending) {
            generateSnippets(projectId);
        }
    }, [open, projectId, snippetsData, isPending, generateSnippets]);
                ...
                <SheetHeader className="pb-4 border-b">
                    <div className="flex items-center justify-between pr-8">
                        <div>
                            ...
                            <SheetDescription>
                                {project?.title || "Loading..."} — Game card previews
                            </SheetDescription>
                        </div>
                        ...
                        <div className="flex flex-col items-center justify-center py-16 space-y-4">
                            ...
                            <div className="text-center space-y-2">
                                <p className="text-lg font-medium text-foreground">
                                    Generating your project cards...
                                </p>
                                <p className="text-sm text-muted-foreground max-w-md">
                                    Our AI is analyzing your project and creating memorable snippets.
                    ...
                    {snippetsData && !snippetsData.success && !isPending && (
                        <div className="flex flex-col items-center justify-center py-16 space-y-4">
                            ...
                            <p className="text-sm text-muted-foreground max-w-md text-center">
                                {snippetsData.error || "The project might not have enough content yet. Continue your interview to add more details."}
                            </p>
                        </div>
                    )}
                </div>
