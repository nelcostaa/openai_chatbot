...
import { Plus, FolderOpen, ArrowRight, User, LogOut } from "lucide-react";
        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="max-w-6xl mx-auto px-6 py-10">
                ...
                <div className="mb-10">
                    ...
                    <h1 className="font-project text-4xl font-semibold text-foreground mb-2">
                        Welcome back, {userName}
                    </h1>
                    <p className="text-muted-foreground text-lg">
                        Your projects are waiting to be continued.
                    </p>
                </div>
                ...
                <div className="flex flex-wrap gap-4 mb-12">
                    ...
                    {projectsArray.length > 0 && (
                        <Button
                            variant="outline"
                            onClick={() => handleContinue(projectsArray[0].id.toString())}
                            className="h-14 px-6 text-lg font-medium"
                        >
                ...
                <div className="flex gap-8 mb-10 pb-10 border-b border-border">
                    <div>
                        ...
                        <p className="text-muted-foreground text-base">Total Projects</p>
                    </div>
                </div>
